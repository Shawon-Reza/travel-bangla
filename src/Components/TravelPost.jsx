        ...
        <div className="max-w-lg mx-auto p-6 bg-white shadow-lg rounded-xl">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="flex space-x-2 mb-3">
                    <input type="number" name="budget_min" className="w-1/2 p-2 border rounded" required />
                    <input type="number" name="budget_max" className="w-1/2 p-2 border rounded" required />
                </div>
                ...
                <input type="url" name="host_whatsapp" className="w-full p-2 border rounded mb-3" required />
