...
const FindFriendPostDisplay = ({ travelpost }) => {
    ...
    const handleSlide = (direction) => {
        if (!travelpost?.destination_images?.length) return;
